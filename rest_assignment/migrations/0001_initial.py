    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("bid_volume", models.IntegerField(max_length=11)),
                ("executed_volume", models.IntegerField(max_length=11)),
                (
                    "stock_id",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="rest_assignment.stocks",
                    ),
                ),
                (
                    "user_id",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("stock_id", models.IntegerField(max_length=11)),
